...
public class SearchPeople {
    ...
    public String toString() {
        ...
        sb.append(SearchPeople.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SearchPeople) == false) {
            return false;
        }
        SearchPeople rhs = ((SearchPeople) other);
